#!/usr/bin/env python3
"""Build 2 B2B SEO articles for ribbonbow123 — 2026-09-24 (195 AM + 196 PM).

Loads content from /tmp/art195_content.py and /tmp/art196_content.py.
"""
import os, sys

sys.path.insert(0, "/tmp")
from art195_content import INTRO_195, SECTIONS_195, KEYWORDS_195
from art196_content import INTRO_196, SECTIONS_196, KEYWORDS_196
...
# Article 195 (AM)
HEADLINE_195 = "Mill-Side Q1-2027 Supplier-Financial-Health Monitoring Tier-2 Tier-3 Sub-Supplier 12-Signal Architecture"
SHORT_195 = "Mill-Side Q1-2027 Supplier-Financial-Health Monitoring Tier-2 Tier-3 Sub-Supplier 12-Signal Architecture"
AUDIENCE_195 = "global brand procurement directors, retail private-label merchandising controllers, OEM mill-side procurement teams, Q1 2027 finance controllers, brand-buyer private-label program owners, customs-broker partners, trade-credit-insurance partners, and executive-board sponsors"
SLUG_195 = "supplier-financial-health-monitoring-tier-2-tier-3-sub-supplier-12-signal"

# Article 196 (PM)
HEADLINE_196 = "Mill-Side Q1-2027 Supply-Chain-Finance Engineering Reverse-Factoring Receivables-Discounting Forfaiting ESG-Linked Working-Capital Architecture"
SHORT_196 = "Mill-Side Q1-2027 Supply-Chain-Finance Engineering Reverse-Factoring Receivables-Discounting Forfaiting ESG-Linked Working-Capital Architecture"
AUDIENCE_196 = "global brand procurement directors, retail private-label merchandising controllers, OEM mill-side finance teams, Q1 2027 treasury controllers, brand-buyer private-label program owners, CFO / CSO sustainability committees, customs-broker partners, trade-finance partners, and executive-board sponsors"
SLUG_196 = "supply-chain-finance-engineering-reverse-factoring-receivables-discounting-forfaiting-esg-linked-working-capital"


if __name__ == "__main__":
    f1, h1 = build(195, "am", HEADLINE_195, SHORT_195, AUDIENCE_195, INTRO_195, SECTIONS_195, KEYWORDS_195, SLUG_195)
    f2, h2 = build(196, "pm", HEADLINE_196, SHORT_196, AUDIENCE_196, INTRO_196, SECTIONS_196, KEYWORDS_196, SLUG_196)
