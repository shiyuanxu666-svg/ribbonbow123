#!/usr/bin/env python3
"""Build 2 B2B SEO articles for ribbonbow123 — 2026-09-26 (205 AM + 206 PM).

Loads content from /tmp/art205_content.py and /tmp/art206_content.py.
"""
import os, sys

sys.path.insert(0, "/tmp")
from art205_content import INTRO_205, SECTIONS_205, KEYWORDS_205
from art206_content import INTRO_206, SECTIONS_206, KEYWORDS_206
...
# Article 205 (AM)
HEADLINE_205 = "Mill-Side Q1-2027 Brand-Buyer Private-Label Ribbon-OEM Total-Cost-of-Ownership TCO-Decoder 25-Component Quote-Reverse-Engineering Architecture"
SHORT_205 = "Mill-Side Q1-2027 Brand-Buyer Private-Label Ribbon-OEM Total-Cost-of-Ownership TCO-Decoder 25-Component Quote-Reverse-Engineering Architecture"
AUDIENCE_205 = "global brand procurement directors, retail private-label merchandising controllers, OEM mill-side finance teams, Q1 2027 merchandising controllers, brand-buyer private-label program owners, finance teams, sourcing teams, and executive-board sponsors"
SLUG_205 = "brand-buyer-private-label-ribbon-oem-tco-decoder-25-component-quote-reverse-engineering"

# Article 206 (PM)
HEADLINE_206 = "Mill-Side Q1-2027 Supplier-Financial-Health Tier-2-Tier-3 Sub-Supplier Rating Monitoring SRM-Resilience Early-Warning Architecture"
SHORT_206 = "Mill-Side Q1-2027 Supplier-Financial-Health Tier-2-Tier-3 Sub-Supplier Rating Monitoring SRM-Resilience Early-Warning Architecture"
AUDIENCE_206 = "global brand procurement directors, retail private-label merchandising controllers, OEM mill-side SRM teams, Q1 2027 finance controllers, brand-buyer private-label program owners, supplier-risk-management teams, and executive-board sponsors"
SLUG_206 = "supplier-financial-health-tier-2-tier-3-sub-supplier-rating-monitoring-srm-resilience-early-warning"


if __name__ == "__main__":
    f1, h1 = build(205, "am", HEADLINE_205, SHORT_205, AUDIENCE_205, INTRO_205, SECTIONS_205, KEYWORDS_205, SLUG_205)
    f2, h2 = build(206, "pm", HEADLINE_206, SHORT_206, AUDIENCE_206, INTRO_206, SECTIONS_206, KEYWORDS_206, SLUG_206)
