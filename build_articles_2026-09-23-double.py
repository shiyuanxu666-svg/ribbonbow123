#!/usr/bin/env python3
"""Build 2 B2B SEO articles for ribbonbow123 — 2026-09-23 (191 AM + 192 PM).

Loads content from /tmp/art191_content.py and /tmp/art192_content.py.
"""
import os, sys

sys.path.insert(0, "/tmp")
from art191_content import INTRO_191, SECTIONS_191, KEYWORDS_191
from art192_content import INTRO_192, SECTIONS_192, KEYWORDS_192
...
# Article 191 (AM)
HEADLINE_191 = "Mill-Side Q1-2027 HS-Code Digitization FTA-Utilization Origin-Documentation DPP-Ready Traceability Architecture"
SHORT_191 = "Mill-Side Q1-2027 HS-Code Digitization FTA-Utilization Origin-Documentation DPP-Ready Traceability Architecture"
AUDIENCE_191 = "global brand procurement directors, retail private-label merchandising controllers, OEM mill-side trade-compliance teams, Q1 2027 customs-trade-compliance officers, brand-buyer private-label program owners, customs-broker partners, and executive-board sponsors"
SLUG_191 = "hs-code-digitization-fta-utilization-origin-documentation-dpp-traceability"

# Article 192 (PM)
HEADLINE_192 = "Mill-Side Q1-2027 AI-Vision Inline Defect-Detection Closed-Loop Yield-Recovery OEE-Dashboard Pareto-Engine Architecture"
SHORT_192 = "Mill-Side Q1-2027 AI-Vision Inline Defect-Detection Closed-Loop Yield-Recovery OEE-Dashboard Pareto-Engine Architecture"
AUDIENCE_192 = "global brand procurement directors, retail private-label merchandising controllers, OEM mill-side quality-and-production teams, Q1 2027 supply-chain-resilience officers, brand-buyer private-label program owners, factory-quality-engineering leaders, and executive-board sponsors"
SLUG_192 = "ai-vision-inline-defect-detection-closed-loop-yield-recovery-oee-pareto"


if __name__ == "__main__":
    f1, h1 = build(191, "am", HEADLINE_191, SHORT_191, AUDIENCE_191, INTRO_191, SECTIONS_191, KEYWORDS_191, SLUG_191)
    f2, h2 = build(192, "pm", HEADLINE_192, SHORT_192, AUDIENCE_192, INTRO_192, SECTIONS_192, KEYWORDS_192, SLUG_192)
